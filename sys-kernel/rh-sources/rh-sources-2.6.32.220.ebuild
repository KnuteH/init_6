...
SRC_URI="${SRC_URI_PREFIX}/6Client/en/os/SRPMS/kernel-2.6.32-220.13.1.el6.src.rpm
	${SRC_URI_PREFIX}/6ComputeNode/en/os/SRPMS/kernel-2.6.32-220.13.1.el6.src.rpm
	${SRC_URI_PREFIX}/6Server/en/os/SRPMS/kernel-2.6.32-220.13.1.el6.src.rpm
	${SRC_URI_PREFIX}/6Workstation/en/os/SRPMS/kernel-2.6.32-220.13.1.el6.src.rpm"
...
src_unpack() {
	...
	tar -xpf "${WORKDIR}/linux-2.6.32-220.13.1.el6.tar.bz2" || die
	mv "linux-2.6.32-220.13.1.el6" "${S}" || die
	rm -f "${WORKDIR}/linux-2.6.32-220.13.1.el6.tar.bz2" || die
