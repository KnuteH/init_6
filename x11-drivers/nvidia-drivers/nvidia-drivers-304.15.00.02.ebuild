...
SRC_URI="x86? ( http://us.download.nvidia.com/opengl/4.3/linux/${X86_NV_PACKAGE}.run )
	 amd64? ( http://us.download.nvidia.com/opengl/4.3/linux/${AMD64_NV_PACKAGE}.run )
	 amd64-fbsd? ( http://us.download.nvidia.com/opengl/4.3/freebsd/${AMD64_FBSD_NV_PACKAGE}.tar.gz )
	 x86-fbsd? ( http://us.download.nvidia.com/opengl/4.3/freebsd/${X86_FBSD_NV_PACKAGE}.tar.gz )"
